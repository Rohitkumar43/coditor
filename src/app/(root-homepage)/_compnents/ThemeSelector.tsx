 ...
 * 
 * A dropdown component that allows users to select different editor themes.
 * Features include:
 * - Animated dropdown menu
 * - Theme preview with colors and icons
...
// Map theme IDs to their corresponding icons
...
function ThemeSelector() {
  ...
  // Custom hook to handle hydration mismatch
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown Menu with AnimatePresence for exit animations */}
      <AnimatePresence>
        {isOpen && (
          <motion.div
